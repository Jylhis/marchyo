...
| `nixosModules.hardware.<profile>` | [nixos-hardware](https://github.com/NixOS/nixos-hardware) per-machine profiles, re-exported (e.g. `lenovo-thinkpad-x1-9th-gen`, `framework-13-7040-amd`, `common-pc-ssd`) |
...
| `checks.{system}.*` | Evaluation test suite (Linux systems only) |
