...
| `Super + .` | Emoji picker (in-shell with `marchyo.shell`, else vicinae) |
...
| `Super + Ctrl + V` | Clipboard history (in-shell/cliphist with `marchyo.shell`, else vicinae) |
...
| Wi-Fi / `eth` | Click for the Wi-Fi manager (nmtui, floating) |
