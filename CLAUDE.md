...
| Option | Default | Description |
|--------|---------|-------------|
| `marchyo.dictation.enable` | `false` | Enable voxtype dictation + the Hyprland Super+H toggle bind |
